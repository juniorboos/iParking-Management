         ...
         <form className="form" onSubmit={addSpot}>
            <div className="formDiv">
               ...
               <div className="inputDiv">
                  ...
                  <div>
                     <input required className="input" style={{width: 150, textAlign: 'center', marginRight: 6}} defaultValue={options.action === 'edit' ? options.spot.coordinates[0] : null} type="number" step="any" name="name" onChange={e => setLatitude(e.target.value)} placeholder="Latitude"/>
                     <input required className="input" style={{width: 150, textAlign: 'center'}} defaultValue={options.action === 'edit' ? options.spot.coordinates[1] : null} type="number" step="any" name="name" onChange={e => setLongitude(e.target.value)} placeholder="Longitude"/>
                  </div>
               </div>                  
            </div> 
