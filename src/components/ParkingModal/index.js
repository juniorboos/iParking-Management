      ...
      if (parking !== null) {
         ...
         parking.vehiclesAllowed.map((vehicleLabel) => {
            return vehicles.push(
               vehicleOptions.find(({ label }) => label === vehicleLabel)
            );
         });
      ...
      >
         <form className="form" onSubmit={addParking}>
            <div className="formDiv">
               <div className="inputDiv">
                  ...
                  <input
                     ...
                     className="input"
                     defaultValue={
                        options.action === "edit" ? options.parking.name : null
                     }
                     type="text"
                     name="name"
               ...
               <div className="inputDiv">
                  ...
                  <Select
                     onChange={(selectedOption) =>
                        setVehiclesSelected(selectedOption)
                     }
               ...
               <div className="inputDiv">
                  ...
                  <input
                     ...
                     defaultValue={
                        options.action === "edit"
                           ? options.parking.address
                           : null
                     }
                     type="text"
                     name="name"
                     onChange={(e) => setAddress(e.target.value)}
                     placeholder="Rua João Carvalho, nº 537, Bragança, Portugal, 5300-000"
                  />
               </div>
               <div className="inputDiv">
                  ...
                  <input
                     ...
                     className="input"
                     defaultValue={
                        options.action === "edit" ? options.parking.image : null
                     }
                     type="text"
                     name="name"
            ...
            <div className="modalFooter">
               {options.action === "add" ? (
                  <button type="submit" className="footerButton add">
                     Submit
                  </button>
               ) : (
                  <>
                     <button
                        ...
                        className="footerButton delete half"
                     >
                        Delete
                     </button>
                     <button type="submit" className="footerButton edit half">
                        Save
                     </button>
                  </>
               )}
